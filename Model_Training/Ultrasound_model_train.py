# breast_cancer_ultrasound_model.py
...
train_gen, val_gen = load_data(data_dir, binary=False)
...
# Save the model
model.save('my_model/mri_model.h5')

# Save the labels
labels = train_gen.class_indices
with open('my_model/mri_labels.txt', 'w') as f:
